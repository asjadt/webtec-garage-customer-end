...
export default function Table2({
  ...
  return (
    <div
      className={` min-h-[300px] scrollbar-thin scrollbar-track-base-100 scrollbar-thumb-primary-content top-0 w-full scrollbar-w-1 bg-base-200 md:bg-base-200`}
    >
      {/* FOR DESKTOP VIEW  */}
      <table className="hidden md:table gap-2 rounded-xl ">
        {header ? (
          <thead className="bg-base-100 border-b border-primary-content">
