...
export default function BusinessTiming() {
  const { userInfo } = useViewProfileContext();
            ...
            <div className={`flex flex-col`}>
              {timingData.map((day, value) => (
                ...
                >
                  ...
                  {/* START TIME  */}
                  <div
                    className={`w-[40%] md:w-[30%] block ${errors?.times?.find((e) => e?.id === day?.day)?.end_at &&
                  ...
                  {/* END TIME  */}
                  <div
                    className={`w-[40%] md:w-[30%] block ${errors?.times?.find((e) => e?.id === day?.day)
                      ?.start_at &&
                      !timingData[day.day].is_weekend &&
                      "h-[80px]"
                      } `}
