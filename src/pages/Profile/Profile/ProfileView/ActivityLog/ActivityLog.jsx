...
export default function ActivityLog() {
  const { userId } = useViewProfileContext();
  // POPUP OPTIONS
  ...
  return (
    <div className="mt-10">
      <div className="relative h-full">
        ...
        <div className="flex flex-col md:flex-row justify-start items-center relative gap-5">
        ...
        <div className="pt-5 relative">
          ...
          {/* {data?.total !== 0 && (
            <div
              ...
              className="flex-col flex justify-center bg-base-200 md:bg-base-200 items-center py-1"
            >
              <Pagination
