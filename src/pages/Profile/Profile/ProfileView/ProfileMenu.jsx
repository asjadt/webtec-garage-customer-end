  ...
  return (
    <div className="mb-5">
      ...
      <div className="collapse lg:hidden collapse-arrow bg-base-200 shadow-md shadow-primary-content">
        ...
        <div className="collapse-content ">
          <div className="mt-4 flex flex-col gap-1 justify-between items-center  py-2">
            <button
              className={`${selectedMenu !== "Personal Details" && "btn-outline"
            ...
            {userInfo?.business_id ? (
              <button
                className={`${selectedMenu !== "Business Details" && "btn-outline"
                  } font-semibold btn btn-primary w-full`}
            ...
            {userInfo?.business_id ? (
              <button
                className={`${selectedMenu !== "Business Timing" && "btn-outline"
                  } font-semibold btn btn-primary w-full`}
            ...
            <button
              className={`${selectedMenu !== "Activity Log" && "btn-outline"
                } font-semibold btn btn-primary w-full`}
            ...
            <button
              className={`${selectedMenu !== "Change Password" && "btn-outline"
                } font-semibold btn btn-primary w-full`}
      ...
      <div className="mt-1 hidden lg:grid lg:grid-cols-5 justify-center  gap-2">
        <button
          className={`${selectedMenu !== "Personal Details"
              ? "btn-outline"
        ...
        {userInfo?.business_id ? (
          <button
            className={`${selectedMenu !== "Business Details"
                ? "btn-outline"
                : "shadow-lg shadow-primary-content"
              } font-semibold btn btn-primary w-full mx-auto`}
            onClick={() => setSelectedMenu("Business Details")}
        ...
        {userInfo?.business_id ? (
          <button
            className={`${selectedMenu !== "Business Timing"
                ? "btn-outline"
                : "shadow-lg shadow-primary-content"
              } font-semibold btn btn-primary w-full mx-auto`}
            onClick={() => setSelectedMenu("Business Timing")}
        ...
        <button
          className={`${selectedMenu !== "Change Password"
              ? "btn-outline"
              : "shadow-lg shadow-primary-content"
            } font-semibold btn btn-primary w-full mx-auto`}
          onClick={() => setSelectedMenu("Change Password")}
